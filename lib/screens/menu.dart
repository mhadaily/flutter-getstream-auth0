...
class _MenuScreenState extends State<MenuScreen> {
  ...
  final List<Widget> tabs = [
    ...
    if (AuthService.instance.profile?.isEmployee)
      CommunityView()
    else
      ChatView(),
    ProfileScreen(),
  ...
  BottomNavigationBar _bottomNavigationBar(Auth0User? profile) {
    return BottomNavigationBar(
      ...
      items: <BottomNavigationBarItem>[
        ...
        BottomNavigationBarItem(
          icon: profile?.isCustomer
              ? Icon(Icons.support_agent)
              : Icon(Icons.group),
          label: profile?.isCustomer ? "Support" : "Community",
        ),
        BottomNavigationBarItem(
